import { SIDE_NAV_SECTIONS } from "@/config/scrollDeckPages"
...
export function SectionNav({
  ...
  return (
    <div className="fixed right-[30px] top-1/2 -translate-y-1/2 hidden flex-col gap-4 z-[200] md:flex">
      {SIDE_NAV_SECTIONS.map((item) => (
        <button
          key={item.section}
