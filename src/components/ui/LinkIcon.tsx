...
type IconSpec = {
  node: ReactNode
  // Brand marks are filled silhouettes; everything else uses lucide's stroked style.
  fill?: boolean
  viewBox?: string
}

// Stroked paths copied from lucide (ISC) so the chips match the main site without adding an icon dependency.
